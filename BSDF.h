...
public:
    ...
    glm::vec3 sample_f(glm::vec3& w_i, const glm::vec3 &w_o, const HitRecord &hit_record, float &pdf, BxDF::Type& sampled_type, BxDF::Type bxdfTypes = BxDF::Type::BXDF_ALL) const;
