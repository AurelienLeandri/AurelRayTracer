...
void RayTracerCPU::_createColorResources() {
...
void RayTracerCPU::_createDepthResources() {
...
void RayTracerCPU::_createUniformBuffers() {
    const std::vector<VkImageView>& swapChainImageViews = _vulkan.getSwapChainImageViews();
...
void RayTracerCPU::_generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void RayTracerCPU::_updateUniformBuffer(uint32_t currentImage) {
