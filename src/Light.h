...
public:
    ...
    // Return the density or a given pair of wi and wo vectores for sampling the light
    virtual float pdf(const glm::vec3& point, const HitRecord& hit_record) const;
